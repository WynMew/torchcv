...
parser.add_argument('--checkpoint', default='./examples/ssd/ckpt.pth', type=str, help='checkpoint path')
...
#net.load_state_dict(torch.load('fpnssd512_20_trained.pth'),strict=False)
...
#vgg_weights = torch.load('vgg16.pth')
#print('Loading base network...')
#net.extractor.load_state_dict(vgg_weights,strict=False)

resnet50_weights = torch.load('resnet50-19c8e357.pth')
net.extractor.load_state_dict(resnet50_weights,strict=False)
# Dataset
...
trainset = ListDataset(root='/home/wynmew/data/VOCdevkit',
                       list_file=['torchcv/datasets/voc/voctrainval'],
...
testset = ListDataset(root='/home/wynmew/data/VOCdevkit',
                      list_file='torchcv/datasets/voc/voc07_test',
...
criterion = SSDLoss(num_classes=MyClassNum+1)
