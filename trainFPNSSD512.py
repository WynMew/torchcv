...
parser.add_argument('--checkpoint', default='./examples/ssd/ssdckpt.pth', type=str, help='checkpoint path')
...
trainset = ListDataset(root='/home/wynmew/workspace/Data',
                       list_file=['8000listAll'],
...
testset = ListDataset(root='/home/wynmew/workspace/Data',
